...
public class Pedido {
    ...
    public void setPedido (String _idpedido, String _idexpendio, String _idfabricante,
            String _idcerveza, String _cantidad, String _fachapedido, 
            String _fachaentrega, String _preciouni){
         ...
         setPreciouni(Integer.parseInt(_preciouni)); 
    }
