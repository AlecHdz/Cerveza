...
public class JDPro2 extends javax.swing.JDialog {
    Produccion pro;
    static Produccion objetoProduccion = new Produccion();
    Metodos_sql metodos = new Metodos_sql();

  
    public JDPro2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

   public JDPro2 (java.awt.Dialog parent, boolean modal, Produccion obp){
        super (parent, modal);
        initComponents();
        pro = obp;
        jLabel6.setText(String.valueOf(pro.getIdproduccion()));
        jLabel8.setText(String.valueOf(pro.getCantidad()));
        jLabel9.setText(String.valueOf(pro.getFecha()));
       
        jLabel7.setText(String.valueOf(pro.getIdcerveza()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDPro2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDPro2 dialog = new JDPro2(new javax.swing.JFrame(), true);
