      ...
      public void buscareg() {
        ...
        try {
            ...
            while (resc.next()) {
               ...
               ObjMar.SetMarca(resc.getString("Nombre"), resc.getString("IdFabricante"));
            ...
            while (resc.next()) {
                ...
                ObjFab.SetFabricante(resc.getString("Nombre"), resc.getString("Estado"), resc.getString("Municipio"), resc.getString("Ubicacion"));
